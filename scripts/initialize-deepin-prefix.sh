...
# The official prefix was built for /opt/deepin-wine10-stable.  This Flatpak
# installs the same engine under /app, so only relocate those Wine builtin
# symlinks; c:, z: and device mappings keep their original targets.
